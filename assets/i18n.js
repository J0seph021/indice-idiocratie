...
const I18N = {
  en: {
    ...
    secDumbest: 'Dumbest Move of the Day', secContinents: 'Global Breakdown by Continent', secRankings: 'National Stupidity Rankings', secProfiles: 'Country Profiles', viewProfile: 'Full profile',
    ...
    footLinksT: 'Links', footWordsT: 'Famous last words', footQuote: '"I\'m not a prophet. I was just off by 490 years." — Mike Judge',
  ...
  fr: {
    ...
    secDumbest: 'La connerie du jour', secContinents: 'Vue mondiale par continent', secRankings: 'Palmarès national de la connerie', secProfiles: 'Fiches par pays', viewProfile: 'Fiche complète',
    ...
    footLinksT: 'Liens', footWordsT: 'Le mot de la fin', footQuote: '« Je ne suis pas un prophète. Je me suis juste trompé de 490 ans. » — Mike Judge',
  ...
  es: {
    ...
    secDumbest: 'La estupidez del día', secContinents: 'Panorama mundial por continente', secRankings: 'Ranking nacional de estupidez', secProfiles: 'Fichas por país', viewProfile: 'Ficha completa',
    ...
    footLinksT: 'Enlaces', footWordsT: 'Últimas palabras', footQuote: '«No soy un profeta. Solo me equivoqué por 490 años.» — Mike Judge',
  ...
  de: {
    ...
    secDumbest: 'Dümmster Moment des Tages', secContinents: 'Weltüberblick nach Kontinent', secRankings: 'Nationale Dummheits-Rangliste', secProfiles: 'Länderprofile', viewProfile: 'Vollständiges Profil',
    ...
    footLinksT: 'Links', footWordsT: 'Letzte Worte', footQuote: '„Ich bin kein Prophet. Ich lag nur um 490 Jahre daneben." — Mike Judge',
